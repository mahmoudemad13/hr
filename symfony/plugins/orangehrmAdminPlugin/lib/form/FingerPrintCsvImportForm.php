 ...
 *
 */
class FingerPrintCsvImportForm extends BaseForm {

	private $fingerPrintCsvDataImportService;
	
	public function getFingerPrintCsvDataImportService() {
		if (is_null($this->fingerPrintCsvDataImportService)) {
			$this->fingerPrintCsvDataImportService = new FingerPrintCsvDataImportService();
		}
		return $this->fingerPrintCsvDataImportService;
	}
	...
	public function configure() {
		...
		$this->widgetSchema->setNameFormat('fingerPrintCsvImport[%s]');
	}
	...
	public function save() {
		...
		if (!empty($file)) {
			...
			return $this->getFingerPrintCsvDataImportService()->import($file);
		}
	}
